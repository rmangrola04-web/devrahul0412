...
const target = `<div className="flex flex-wrap justify-between items-center gap-3 pb-3 border-b border-slate-200 dark:border-slate-700">
          <div>
...
const replacement = `<div className="flex flex-wrap justify-between items-center gap-3 pb-3 border-b border-slate-200 dark:border-slate-700">
          <div>
            <h2 className="text-xs font-bold uppercase tracking-wider text-slate-800 dark:text-slate-100 flex items-center gap-1.5">
              <ClipboardList className="w-3.5 h-3.5 text-blue-600" /> Plan Received & Single Vehicle Summary
            </h2>
